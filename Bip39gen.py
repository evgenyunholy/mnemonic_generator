...
st = time.time()
outputtxt = open('mnemonic.txt', 'w')
print("Generating One Million Mnemonics... Please wait...") 

def main():
    palindromic = False
    first_time_entropy = True
    word_count = 12 # How many words 12 or 24
...
def generate_entropy(generated_bit_count):
    ...
    entropy_binary = int_to_padded_binary(entropy, generated_bit_count)
...
def get_hash(entropy):
    ...
    generated_char_count = generated_bit_count // 4
    entropy_hex = binary_to_padded_hex(entropy, generated_char_count)
...
if __name__ == '__main__':
    ...
    print("Generated One Million Valid Mnemonics")
    print(end - start)
    time.sleep(5) 